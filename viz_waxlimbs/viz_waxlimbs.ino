//Hi Alex. Please see comments with '*******' for code you asked about i.e. # of leds, or change colour palettes. 
...
#define LED_TOTAL 108  //Change this to the number of LEDs in your strand.  *******
...
void loop() {  //This is where the magic happens. This loop produces each frame of the visual.
  ...
  ////////////////////////////////////////////////////////////////////////////////////////////////////
  Cycle();  //Changes palette for shuffle mode or button press.
...
//This function calls the appropriate color palette based on "palette"  ******* Alex, see "Palette functions' ~90% down in this document. you can adjust the values for each of these gradients.
...
//////////<Palette Functions> ******** Alex, experiment with changing these values below.
